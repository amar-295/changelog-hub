    ...
    <div className="flex-1 max-w-4xl mx-auto px-8 py-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-text-secondary max-w-2xl leading-relaxed">
          Manage your workspace's branding, public identity, and visibility
          across the platform.
        </p>
      </div>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-bold text-white">Workspace Logo</h3>
              ...
              <div className="mt-4 p-4 rounded-xl bg-blue-500/5 border border-blue-500/10 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-secondary mt-1 leading-relaxed">
                    Changing your subdomain will immediately break all existing
                    links to your public changelog. Existing subscribers won't
